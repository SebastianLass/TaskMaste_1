          ...
          <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
            ...
            <li>
              <a href="taskmaste.php"
                class="block px-4 py-2 hover:bg-lime-400 dark:hover:bg-lime-400 dark:hover:text-white">Inicio</a>
            </li>
            <li>
              <a href="ayuda.php"
                class="block px-4 py-2 hover:bg-lime-400 dark:hover:bg-lime-400 dark:hover:text-white">Ayuda</a>
            </li>
          </ul>
          <div class="py-2">
            <a href="../include/cerrar_sesion.php"
              class="block px-4 py-2 text-sm text-gray-700 hover:bg-lime-400 dark:hover:bg-lime-400 dark:text-gray-200 dark:hover:text-white">Cerrar secion</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="flex-1 p-4 w-full md:w-1/2">
        ...
        <section class="bg-gray-50 dark:bg-gray-900  flex items-center">
          <div class="max-w-screen-xl px-4 mx-auto lg:px-12 w-full">
            <!-- Start coding here -->
            <div class="relative bg-blue-600 shadow-md dark:bg-gray-800 sm:rounded-lg">
                ...
                <div class="w-full md:w-1/2">
                  <form class="flex items-center">
                    ...
                    <div class="relative w-full">
                      ...
                      <input type="text" id="simple-search" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-900 rounded-lg bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" required="">
                    </div>
                  </form>
                </div>
                <div class="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                  <a href="tareas.html">
                  <button type="button" class="flex items-center justify-center px-4 py-2 text-sm font-medium text-neutral-900 rounded-lg bg-lime-400 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
...
<div class="w-full max-w-screen-xl px-4 mx-auto lg:px-12 mt-8">
  <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
      <caption class="p-5 text-lg font-semibold text-left rtl:text-right text-white bg-blue-600 dark:text-white dark:bg-gray-800 rounded-t-lg">
          Tareas pendientes
      </caption>
